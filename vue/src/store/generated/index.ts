...
import MichaelzMudaoMichaelzMudaoMudao from './michaelz/mudao/michaelz.mudao.mudao'
...
export default { 
  ...
  MichaelzMudaoMichaelzMudaoMudao: load(MichaelzMudaoMichaelzMudaoMudao, 'michaelz.mudao.mudao'),
